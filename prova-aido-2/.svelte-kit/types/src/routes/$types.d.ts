...
type LayoutRouteId = RouteId | "/" | "/(app)/carousel" | "/(app)/carousel/chi-siamo" | "/(app)/carousel/contatti" | "/(app)/carousel/donazione" | "/(app)/carousel/storie" | "/(app)/documents" | "/(auth)/login" | null
