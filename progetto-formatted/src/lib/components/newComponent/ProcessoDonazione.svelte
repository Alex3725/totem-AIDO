<script lang="ts">
	...
	const steps: Record<Node, Step> = {
		diagnosi: {
			...
			actions: [{ label: 'Prossimo step', next: 'osservazione', className: 'w-full rounded-[1.05cqw] bg-red-600 px-[1.15cqw] py-[0.85cqh] text-[1.8cqh] font-semibold text-white transition active:scale-[0.98]' }]
		},
		osservazione: {
			icon: '⏱️',
			title: 'Osservazione',
			description: 'Periodo di conferma',
			actions: [{ label: 'Avanti', next: 'comunicazione', className: 'w-full rounded-[1.05cqw] bg-red-600 px-[1.15cqw] py-[0.85cqh] text-[1.8cqh] font-semibold text-white transition active:scale-[0.98]' }]
		},
		comunicazione: {
			icon: '👨‍👩‍👧',
			title: 'Comunicazione',
			description: 'Ai familiari',
			actions: [{ label: 'Continua', next: 'scelta', className: 'w-full rounded-[1.05cqw] bg-red-600 px-[1.15cqw] py-[0.85cqh] text-[1.8cqh] font-semibold text-white transition active:scale-[0.98]' }]
		},
		scelta: {
			title: 'Volontà del paziente',
			actions: [
				{ label: 'Donatore', next: 'prelievo', className: 'w-full rounded-[1.05cqw] bg-green-100 px-[1.15cqw] py-[0.85cqh] text-left text-[1.8cqh] font-semibold text-green-950 transition hover:bg-green-200' },
		...
		familiari: {
			...
			actions: [
				{ label: 'Autorizzano', next: 'prelievo', className: 'w-full rounded-[1.05cqw] bg-green-600 px-[1.15cqw] py-[0.85cqh] text-[1.8cqh] font-semibold text-white transition active:scale-[0.98]' },
